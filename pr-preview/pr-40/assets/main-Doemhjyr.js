import"./modulepreload-polyfill-B5Qt9EMX.js";const n=[{slug:"apriltag-scout",title:"AprilTag Scout",blurb:"Stream a live camera view as AprilTags are outlined with IDs, family metadata, pose hints, and orientation arrows.",icon:"🎯",href:"apps/apriltag-scout/index.html",accent:"#ff914d"},{slug:"camera-filter-lab",title:"FilterCam Playground",blurb:"Open your webcam, then bounce between cinematic, diagnostic, and just-for-fun filter presets complete with live descriptions.",icon:"📷",href:"apps/camera-filter-lab/index.html",accent:"#ff5f6d"},{slug:"scan-vector-lab",title:"Dimension Scan Lab",blurb:"Print a calibrated board, lock onto the tags, and export mm-accurate SVG, DXF, or PDF outlines of objects on the page.",icon:"📐",href:"apps/scan-vector-lab/index.html",accent:"#1f7a8c"},{slug:"clean-url-tracker-remover",title:"Clean URL Trimmer",blurb:"Paste a sharing link and drop all the ad trackers, redirect junk, and campaign tags in one click.",icon:"🧼",href:"apps/clean-url-tracker-remover/index.html",accent:"#48cae4"},{slug:"quick-diff",title:"Quick Diff",blurb:"Line up two snippets and spot the precise character changes with inline highlights for insertions and deletions.",icon:"📝",href:"apps/quick-diff/index.html",accent:"#3a86ff"},{slug:"reverse-engineering-lab",title:"Protocol Decoder Lab",blurb:"Paste unknown data blobs to detect encodings, decode bytes, and identify common protocols automatically.",icon:"🕵️",href:"apps/reverse-engineering-lab/index.html",accent:"#9d4edd"},{slug:"roman-numeral-translator",title:"Roman Numeral Translator",blurb:"Convert roman numerals to numbers (and back) with instant validation and history.",icon:"🏛️",href:"apps/roman-numeral-translator/index.html",accent:"#f08c4a"},{slug:"vibe-palette",title:"Aura Gradient Mixer",blurb:"Blend colors into dreamy gradients and copy CSS-ready code in a snap.",icon:"🌈",href:"apps/vibe-palette/index.html",accent:"#ff7ee7"},{slug:"clipboard-alchemist",title:"Clipboard Alchemist",blurb:"Transform whatever is on your clipboard—format JSON, minify, encode, or replace text.",icon:"🧪",href:"apps/clipboard-alchemist/index.html",accent:"#5ae4a7"},{slug:"palette-maker",title:"Palette Maker",blurb:"Build harmonious palettes with theory-backed suggestions and accessibility checks.",icon:"🎨",href:"apps/palette-maker/index.html",accent:"#f6b44e"},{slug:"qr-code-generator",title:"Local QR Studio",blurb:"Type or paste text, preview four redundancy levels, and download pristine PNG or SVG QR codes instantly.",icon:"🔳",href:"apps/qr-code-generator/index.html",accent:"#64d7ff"},{slug:"browser-diagnostic",title:"Browser Systems Diagnostic",blurb:"Run a slow, deliberate sweep of browser features, permissions, and experimental APIs from a glowing command console.",icon:"🧰",href:"apps/browser-diagnostic/index.html",accent:"#b7410e"},{slug:"nesting-algorithm-visualizer",title:"Nesting Algorithm Lab",blurb:"Watch convex polygons pack themselves into a sheet using fast heuristics, then tweak parameters and rerun instantly.",icon:"🧩",href:"apps/nesting-algorithm-visualizer/index.html",accent:"#ff6f61"}],a=document.getElementById("app-root");function i(){const e=document.createElement("header");return e.className="hero",e.innerHTML=`
  ...
  `,t}function r(){const e=document.createElement("section");return e.className="app-grid",e.setAttribute("aria-label","Available vibe-coded applications"),n.forEach(t=>{e.appendChild(s(t))}),e}function l(){const e=document.createElement("section");return e.className="about",e.innerHTML=`
  ...
  `,e}function o(){const e=document.createElement("section");return e.className="timeline",e.innerHTML=`
    ...
    `,e}function c(){if(!a)return;const e=document.createElement("div");e.className="page-shell",e.appendChild(i()),e.appendChild(r()),e.appendChild(o()),e.appendChild(l()),a.innerHTML="",a.appendChild(e)}c();
